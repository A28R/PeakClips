...
function Recent() {
  ...
  return (
    <div className="w-3/4  my-5 bg-black/30 shadow-md rounded-3xl p-2 overflow-hidden relative hidden lg:flex items-center justify-center flex-col text-white">
      ...
      {request.map((item) => {
        return (
          <div key={item.id} className="w-full px-5">
            <span className="w-full h-16 bg-black/40 rounded-lg shadow-lg my-2 flex items-start justify-center flex-col">
              <span className="w-full flex items-center justify-evenly p-1  relative">
                ...
                <button className="bg-blue-400 font-semibold text-xs text-white px-3 py-1 my-1 rounded-xl">
                  Follow
                </button>
