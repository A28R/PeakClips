...
function Login() {
  ...
  return (
    <div className="lg:w-1/2 lg:h-screen w-full h-1/2 bg-blue-600  flex items-center justify-center flex-col py-3">
      <form
      ...
      >
        <div className="flex items-center justify-center flex-col w-full lg:p-4 p-1 ">
          ...
          <span className="lg:w-4/5 w-11/12 lg:flex items-center justify-end text-sm text-gray-300">
            ...
            <span className="mx-2 text-gray-100 font-bold"> Sign up</span>
          </span>
        </div>
      ...
      {/* <button
        className="text-white flex items-center justify-center bg-blue-800 px-1 lg:px-16 py-4 text-xs lg:text-sm rounded-md shadow-lg font-semibold cursor-pointer my-6"
